...
# 6.5 Computing Contiguity Spatial Weights
...
## 6.5.1 Computing (QUEEN) contiguity based neighbours
...
## 6.5.2 Creating (ROOK) contiguity based neighbours
...
## 6.5.3 Visualising contiguity weights
...
# 6.6 Computing distance based neighbours
...
## 6.6.1 Determine the cut-off distance
...
## 6.6.2 Computing fixed distance weight matrix
...
## 6.6.3 Computing adaptive distance weight matrix
...
## 6.7.1 Row-standardised weights matrix
...
# 6.8 Application of Spatial Weight Matrix
...
## 6.8.1 Spatial lag with row-standardised weights
...
## 6.8.2 Spatial lag as a sum of neighbouring values
