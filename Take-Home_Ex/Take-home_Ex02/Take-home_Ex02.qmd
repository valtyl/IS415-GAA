...
Visualising combined_jakarta in terms of population not yet vaccinated, target population to be vaccinated and total population:
...
Visualising `combined_jakarta` in terms of population not yet vaccinated, target population to be vaccinated and total population again:
...
We need to compute the monthly vaccination rate: vaccination rate (in %) = (target - number of people not vaccinated yet) / target \* 100
