...
Conclusion: Since the observed G(r) is far above G(theo) and the envelope, it shows that the water points in Osun, Nigeria are clustered. Hence, we reject the null hypothesis that the distribution of water points in Osun, Nigeria is randomly distributed at 95% confidence level.
